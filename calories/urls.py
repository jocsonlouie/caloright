...
from . views import HomePageView, LoginPage, LogOutPage, select_food, add_food, RegisterPage, ProfilePage, update_food, delete_food, developers, tracker, about, calculator
